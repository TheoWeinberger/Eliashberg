...
#ifndef ELIASHBERG3D_H
#define ELIASHBERG3D_H
...
private:
     ...
     * 
     * @param pX Momentum space vector in the x direction
     * @param pY Momentum space vector in the y direction
     * @param pZ Momentum space vector in the z direction
     * @return dispersion: a vector containing the dispersion relation of the system as a function of qX and qY
     */
    arma::cube _Dispersion(const arma::vec&, const arma::vec&, const arma::vec&);
     ...
     */
    arma::vec _QMinus(const arma::vec&, const arma::vec&, const arma::vec&);
     ...
     */
    arma::vec _QPlus(const arma::vec&, const arma::vec&, const arma::vec&);
     ...
     * @param qZ Momentum space vector in the z direction
     */
    void _Eta(const arma::vec&, const arma::vec&, const arma::vec&);
     ...
     * @return qHatMinus: a vector containing the negative root of the susceptibility pole
     */
    double _QMinus(const double&, const double&, const double&);
     ...
     * @return qHatPlus: a vector containing the positive root of the susceptibility pole
     */
    double _QPlus(const double&, const double&, const double&);
     ...
     */
    double _Eta(const double&, const double&, const double&);
     ...
     * @return omega0: The cutoff frequency for the integration of the dynamic susceptibility
     */
    double _Omega0(const double&, const double&, const double&);
     ...
     */
    std::vector<arma::cube> _ChiQNu(const arma::vec&, const arma::vec&, const arma::vec&, const arma::vec&);
     ...
     */
    std::vector<arma::cx_cube> _MatsuConv(const std::vector<arma::cx_cube>&, const std::vector<arma::cx_cube>&, const int&, const int&, const bool&, const bool&);
    ...
    /**
     * @brief alphaT: The assymetry in the z direction (a measure of tetragonality)
     * 
     */
    double _alphaT;
