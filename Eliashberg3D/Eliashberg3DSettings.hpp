/**
 * @file Eliashberg3DSettings.hpp
 * @author Theo Weinberger
 * @brief Code to read in settings for the Eliashberg code from a .cfg file
 * 
 * This file is passed a string from Eliashberg3DMain corresponding to a file 
...
#ifndef ELIASHBERG3DSETTINGS_H
#define ELIASHBERG3DSETTINGS_H
